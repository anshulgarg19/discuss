			...
			<div class="tab-content">
				<div role="tabpanel" class="tab-pane" id="signup">
					<form id="register-form" class="form-signin" method="POST" enctype="multipart/form-data" action="/index.php/homepage/register">
						...
						<label class="sr-only" for="phone_num">Phone Num </label><input placeholder="phone number(10 digits)" class="form-control" type="text" name="pnum" id="phone_num">
				...
				<div role="tabpanel" class="tab-pane active" id="login">
					<form class="form-signin">
						<label class="sr-only" for="login_email">E-mail id or phone number</label><input placeholder="Email id or 10 digit phone number" class="form-control" type="text" name="email" id="login_email" required autofocus>
