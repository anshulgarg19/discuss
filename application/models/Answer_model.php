...
class Answer_Model extends CI_Model {
    ...
    public function getAnswersToQuestion($question_id,$offset,$limit) {
    	...
    	$answers = $this->db->query("SELECT firstname, profile_pic, Users.user_id, Answers.created_on, answer_content FROM Users INNER JOIN Answers ON Answers.user_id=Users.user_id WHERE Answers.question_id=? order by created_on desc limit ?,?;", array($question_id,$offset,$limit));
